...
# 用法:
#   bash scripts/train/run_training.sh 0 8                                        # GPU 0, rank=8, 默认配置
#   bash scripts/train/run_training.sh 1 16                                       # GPU 1, rank=16, 默认配置
#   bash scripts/train/run_training.sh 0 8 configs/qwen3_4b_base_last3.yaml last3 # 指定配置+标签
#
# 并行调度 (两个 tmux pane):
