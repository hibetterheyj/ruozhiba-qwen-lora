...
Usage (from repo root):
    python upload/scripts/data/build_sft_data.py
    python upload/scripts/data/build_sft_data.py --dry-run   # preview counts without writing
"""
...
# ---------------------------------------------------------------------------
# upload/scripts/data -> 仓库根目录为上三级
PROJECT_ROOT = Path(__file__).resolve().parents[3]
TIEBA_DATA_DIR = PROJECT_ROOT / "data" / "tieba"
PROMPT_CONFIG = PROJECT_ROOT / "upload" / "configs" / "prompts.yaml"
