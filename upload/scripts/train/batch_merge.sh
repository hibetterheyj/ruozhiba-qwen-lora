...
# 用法（仓库根目录）: bash upload/scripts/train/batch_merge.sh
#
# 串行执行 (每次合并约 3-5 分钟)
# 总预计耗时: ~60-100 分钟
...
BASE_MODEL="${REPO_ROOT}/models/Qwen3-4B-Instruct-2507"
SAVES_DIR="${REPO_ROOT}/LLaMA-Factory/saves/qwen3-4b/lora"
MERGED_DIR="${REPO_ROOT}/models/merged"
MERGE_CONFIG="${REPO_ROOT}/upload/configs/qwen3_4b_merge.yaml"
